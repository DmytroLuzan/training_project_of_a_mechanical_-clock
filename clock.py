...
img = pygame.image.load('img/2.jpeg').convert_alpha()
...
while True:
    ...
    pygame.draw.line(surface, pygame.Color('red'), (H_WIDTH, H_HEIGHT), get_clock_pos(clock60, second, 'sec'), 3)
    ...
    pygame.draw.arc(surface, pygame.Color('blue'),
